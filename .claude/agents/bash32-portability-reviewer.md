...
description: Reviews Diggory shell and Bats diffs against the current macOS Bash 3.2, errexit, timeout, TTY, BSD-tool, and CI-runner pitfalls recorded in AGENTS.md. Use after changes under diggory, install.sh, bin/**, lib/**, scripts/**, or tests/*.bats.
tools: Read, Grep, Glob, Bash
---

# Diggory shell portability reviewer
...
1. Compare the full diff with its branch base. Restrict findings to `diggory`,
