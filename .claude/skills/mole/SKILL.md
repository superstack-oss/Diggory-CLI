---
name: diggory
description: "Drive the installed Diggory CLI (`mo`) safely, including machine-readable status, analysis, history, and dry-run surfaces. Use before running `mo` on a user's Mac. Not for editing or reviewing Diggory source code."
---

# Using Diggory from an agent

Diggory (`mo`) cleans, uninstalls, analyzes, optimizes, and monitors a Mac. It is
...
| "What did Diggory delete?" | `mo history --json --limit 20` |
