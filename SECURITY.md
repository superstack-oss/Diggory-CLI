...
Diggory is a local system maintenance tool. It includes high-risk operations such as cleanup, uninstall, optimization, and artifact removal. We treat safety boundaries, deletion logic, and release integrity as security-sensitive areas.
...
- Diggory version and install method
- macOS version
...
- False negatives where Diggory refuses to clean something
...
## Security-Focused Areas in Diggory
