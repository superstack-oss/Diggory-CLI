...
setup() {
    ...
    # hardcodes the real /Applications roots, so we patch _DIGGORY_BUNDLE_RESOLVER_APP_ROOTS
...
_DIGGORY_BUNDLE_RESOLVER_APP_ROOTS=("$FAKE_APPS")
EOF
}
...
mdfind() { return 0; }
export -f mdfind
_DIGGORY_BUNDLE_RESOLVER_APP_ROOTS=("$CASK_ROOT")
